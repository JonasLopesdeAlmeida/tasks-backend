...
pipeline {
    ...
    stages{
        ...
        stage ('Deploy Frontend') { 
            steps {
                dir('frontend')  {
                    git branch: 'master', url: 'https://github.com/JonasLopesdeAlmeida/tasks-frontend'
        ...
        stage ('Functional Test') { 
            steps {  
                dir('functional-test')  {
                    git branch: 'main', url: 'https://github.com/JonasLopesdeAlmeida/tasks-functional-tests'
                    bat 'mvn test' 
                }
            }    
         }            
